...
def Main():
	...
	numArgs = parse.add_mutually_exclusive_group()
	numArgs.add_argument("-s", "--size", help="Specifies number of password characters.", action="store_true")
	numArgs.add_argument("pwSize", help="Desired password size.", type=int)
